...
class Subcategory(models.Model):
    ...
    description = models.TextField(blank=True, null=True)
    image = models.ImageField(upload_to='subcategories/')  # Image for subcategory
...
class Brand(models.Model):
    ...
    logo = models.ImageField(upload_to='brands/')  # Logo for brand
    description = models.TextField(blank=True, null=True)
...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='products/')  # Image for product
